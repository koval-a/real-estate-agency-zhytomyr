...
--
-- Host: localhost:8889
-- Generation Time: Jul 04, 2021 at 11:34 PM
...
CREATE TABLE `obekts` (
                          ...
                          `location_ciity_rayon_id` bigint(20) UNSIGNED DEFAULT NULL,
...
INSERT INTO `obekts` (`id`, `name`, `description`, `price`, `category_id`, `location_rayon_id`, `location_city_id`, `location_ciity_rayon_id`, `square`, `main_img`, `isPublic`, `count_room`, `count_level`, `level`, `opalenyaName`, `appointment_id`, `rieltor_id`, `slug`, `owner_id`, `isPay`, `type_wall_id`, `square_hause_land`, `created_at`, `updated_at`) VALUES
(42, 'Квартира №12', 'Опис квартирп №12 має бути детальним та конструктивним.', '56450.00', 1, 51, NULL, 14, '60.00', '/files/images/default/obekt.jpeg', 1, 3, 9, 5, 'Автономне', 52, 9, 'flat-number-12', 5, 0, 8, NULL, '2021-07-04 23:34:01', '2021-07-04 23:34:01');
...
ALTER TABLE `obekts`
  ...
  ADD KEY `location_ciity_rayon_id` (`location_ciity_rayon_id`);
...
ALTER TABLE `obekts`
  ...
  ADD CONSTRAINT `obekts_ibfk_5` FOREIGN KEY (`location_ciity_rayon_id`) REFERENCES `location_city_rayon` (`id`) ON DELETE NO ACTION,
