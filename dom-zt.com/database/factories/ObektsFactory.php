...
class ObektsFactory extends Factory
{
    ...
    public function definition()
    {
        return [
            ...
            'square' => $this->faker->numberBetween(10, 20000),
            ...
            'rieltor_id' => $this->faker->numberBetween(2, 20),
            'slug' => $this->faker->slug,
            'owner_id' => $this->faker->numberBetween(11, 1000),
            'isPay' => $this->faker->numberBetween(0, 1),
            'type_wall_id' => $this->faker->numberBetween(1, 8),
            'square_hause_land' => $this->faker->numberBetween(5, 1000),
        ];
    }
}
