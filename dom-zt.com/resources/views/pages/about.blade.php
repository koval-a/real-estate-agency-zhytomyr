        ...
        <div class="container">
            <div class="agensy__block">
                <div class="agensy__text">
                    ...
                    <p class="agensy__about">Агентство нерухомості "Житомир" – сучасна та активна компанія. Ми успішно
            ...
            <div class="team__block row m-auto">
                <div class="team__person m-auto col-md-3 p-1">
                    <div class="team__person-img">
                        <img src="/custom/icons/christina-wocintechchat-com--WGbMJU-lPI-unsplash.jpeg" alt="photo rieltor"
                             class="team__person-image">
                    </div>
                    <div class="team__person--info">
                        <h4 class="team__person__title">Ана Петрова</h4>
                        <h5 class="team__person__subtitle">Експерт з нерухомості</h5>
                        <a class="team__person__link" href="telto:+380977777777">
                            +3809700030033
                        </a>
                    </div>
                </div>
